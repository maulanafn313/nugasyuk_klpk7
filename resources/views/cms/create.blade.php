                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <textarea name="description_text" id="description_text" rows="4"
                                class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description_text') }}</textarea>
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <textarea name="description_text2" id="description_text2" rows="4"
                                class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description_text2') }}</textarea>
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <textarea name="description_text3" id="description_text3" rows="4"
                                class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description_text3') }}</textarea>
                    ...
                    <div class="mb-8">
                        ...
                        <div>
                            ...
                            <textarea name="description_text4" id="description_text4" rows="4"
                                class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description_text4') }}</textarea>
