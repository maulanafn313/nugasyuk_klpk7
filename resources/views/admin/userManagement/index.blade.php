        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Daftar pengguna yang terdaftar dalam sistem</p>
                </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $user->province }}</div>
                                </td>
...
<style>
    /* Membuat thead tetap di posisinya saat scroll */
    thead {
        position: sticky;
        top: 0;
        background: white;
