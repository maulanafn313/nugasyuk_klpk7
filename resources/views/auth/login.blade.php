<x-guest-layout>
    ...
    <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
        ...
        <p class="mt-2 text-base text-gray-100">Don’t have an account? <a href="{{ route('register') }}" title=""
                class="font-medium text-blue-800 transition-all duration-200 hover:text-white focus:text-white hover:underline">Create
                a free account</a></p>
                ...
                <div>
                    ...
                    <div class="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                        ...
                        <x-text-input id="email" class="block mt-1 w-full" type="email" name="email"
                            :value="old('email')" placeholder="Enter email to get started" required autofocus
                ...
                <div>
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('password.request') }}" title=""
                            class="text-sm font-medium text-blue-800 transition-all duration-200 hover:text-white focus:text-white hover:underline">
                            Forgot password? </a>
                    </div>
                    <div class="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                ...
                <div class="block mt-4">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox"
                            class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-600" name="remember">
    ...
    <script>
        function togglePassword(id, element) {
            ...
            if (eyeIcon) {
                ...
                if (eyeIconPath) {
                    const newPath = eyeIconPath.getAttribute('d') ===
